package com.jiand.processor;

import com.google.auto.service.AutoService;
import com.jiand.annotation.Interceptor;
import com.jiand.annotation.meta.interceptor.RouteInterceptorInfo;
import com.jiand.processor.base.BaseProcessor;
import com.jiand.processor.config.ProcessorConfig;
import com.jiand.processor.utils.StringUtils;
...
public class InterceptorProcessor extends BaseProcessor {
    ...
    private void generateRouteMetaInfo(Element element, Interceptor annotation) {
        ...
        TypeElement typeElement = mElements.getTypeElement("com.jiand.router.interfaces.ITinyRouterInterceptor");
        ...
        JavaFile.Builder javaFileBuilder = JavaFile.builder(ProcessorConfig.GENERATE_PACKAGE_NAME, TypeSpec.classBuilder(className.toString())
                        .addSuperinterface(mElements.getTypeElement("com.jiand.router.core.loader._IInterceptorLoader").asType())
