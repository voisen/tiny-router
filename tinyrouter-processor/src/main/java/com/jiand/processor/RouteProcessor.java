...
import com.jiand.annotation.Autowired;
import com.jiand.annotation.Route;
import com.jiand.annotation.meta.route.AutowiredInfo;
import com.jiand.annotation.meta.route.RouteType;
...
public class RouteProcessor extends BaseProcessor {
    ...
    private void generateRouteMetaInfo(Element element, Route annotation) {
        ...
        JavaFile.Builder javaFileBuilder = JavaFile.builder(ProcessorConfig.GENERATE_PACKAGE_NAME, TypeSpec.classBuilder(className.toString())
                        .addSuperinterface(mElements.getTypeElement("com.jiand.router.core.loader._ITinyRouteLoader").asType())
